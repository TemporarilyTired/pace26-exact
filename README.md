...
This repository is a slimmed down version of the implementations from my [Masters' Thesis](https://studenttheses.uu.nl/handle/20.500.12932/52103). [This repository](https://github.com/TemporarilyTired/multi-maf-solvers) contains the versions as used in the Thesis including two extra algorithms for this problem.
