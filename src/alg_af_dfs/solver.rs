use super::reductions::AfDbsReductionsInstanceExt;
...
fn solve_cluster(cluster: Instance) -> ArenaTree {
    ...
    let mut bu_state = init_bu_state(cluster);
    bu_state.solve()
}
...
fn solve_split_with_dummy(
        ...
        .is_some()
    {
            ...
            .is_some()
        {
            ...
            let num_leaves_a_dummy = above.num_leaves + 1;
            let num_leaves_b_dummy = below.num_leaves + 1;
            let ord_a_dummy = a_dummy.ord();
            let ord_b_dummy = b_dummy.ord();
            let difficulty_a = (num_leaves_a_dummy - ord_a_dummy, num_leaves_a_dummy);
            let difficulty_b = (num_leaves_b_dummy - ord_b_dummy, num_leaves_b_dummy);
